...
namespace native_fhir
{
   ...
   ViewDefinition_Where
		...
		ResourceTypeString8Pair resource_type_pairs[] = {
			...
			{ ResourceType::ViewDefinition, Str8Lit("ViewDefinition") },
			{ ResourceType::ViewDefinition_Constant, Str8Lit("ViewDefinition_Constant") },
			{ ResourceType::ViewDefinition_Select, Str8Lit("ViewDefinition_Select") },
			{ ResourceType::ViewDefinition_Select_Column, Str8Lit("ViewDefinition_Select_Column") },
			{ ResourceType::ViewDefinition_Select_Column_Tag, Str8Lit("ViewDefinition_Select_Column_Tag") },
			{ ResourceType::ViewDefinition_Where, Str8Lit("ViewDefinition_Where") }
		};
	};
};
#endif